...
function unitone_register_block_patterns() {
	$patterns = array(
		...
		array(
			...
			'slug'     => 'unitone/page/main/one-column',
			'inserter' => false,
			'path'     => get_theme_file_path( 'patterns/private/page/main/one-column.php' ),
		),
		array(
		...
		array(
			...
			'slug'     => 'unitone/page/main/one-column-page-header-featured',
			'inserter' => false,
			'path'     => get_theme_file_path( 'patterns/private/page/main/one-column-page-header-featured.php' ),
		),
		array(
			'title'    => __( 'Main Area (One Column / Page Header (Image)) for Pages', 'unitone' ),
			'slug'     => 'unitone/page/main/one-column-page-header-image',
			'inserter' => false,
			'path'     => get_theme_file_path( 'patterns/private/page/main/one-column-page-header-image.php' ),
		),
		array(
			'title'    => __( 'Main Area (One Column / Page Header (Slim)) for Pages', 'unitone' ),
			'slug'     => 'unitone/page/main/one-column-page-header-slim',
			'inserter' => false,
			'path'     => get_theme_file_path( 'patterns/private/page/main/one-column-page-header-slim.php' ),
		),
		array(
