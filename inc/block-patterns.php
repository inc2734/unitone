...
function unitone_register_block_patterns() {
	$patterns = array(
		...
		array(
			...
			'inserter' => false,
			'path'     => get_theme_file_path( 'patterns/private/archive-product/main/default.php' ),
		),
		array(
			'title'    => __( 'Main Area (Page Header (Image)) for Product Archives', 'unitone' ),
			'slug'     => 'unitone/archive-product/main/page-header-image',
			'inserter' => false,
			'path'     => get_theme_file_path( 'patterns/private/archive-product/main/page-header-image.php' ),
		),
		array(
		...
		array(
			...
			'inserter' => false,
			'path'     => get_theme_file_path( 'patterns/private/bbpress/main/default.php' ),
		),
		array(
			'title'    => __( 'Main Area (Page Header (Image)) for bbPress', 'unitone' ),
			'slug'     => 'unitone/bbpress/main/page-header-image',
			'inserter' => false,
			'path'     => get_theme_file_path( 'patterns/private/bbpress/main/page-header-image.php' ),
		),
		array(
