	...
	function () {
		...
		$override_styles = array_diff(
			array(
				...
				'--unitone--color--background-alt'        => $new_text_color,
				'--unitone--color--text-alt'              => $new_background_color,
				'--wp--preset--color--unitone-accent'     => $new_accent_color . ' !important',
				'--wp--preset--color--unitone-background' => $new_background_color . ' !important',
				'--wp--preset--color--unitone-text'       => $new_text_color . ' !important',
				'--wp--preset--color--unitone-background-alt' => $new_text_color . ' !important',
				'--wp--preset--color--unitone-text-text'  => $new_background_color . ' !important',
