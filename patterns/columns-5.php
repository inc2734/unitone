...
<div data-unitone-layout="responsive-grid" style="--unitone--column-min-width:473px">
	...
	<div data-unitone-layout="decorator -shadow">
		<!-- wp:unitone/with-sidebar {"sidebarWidth":"var(--unitone--cg2)","sidebar":"left","unitone":{"alignItems":"center","gap":0},"lock":{"remove":true,"move":true}} -->
		<div data-unitone-layout="with-sidebar -sidebar:left -align-items:center -gap:0" style="--unitone--sidebar-width:var(--unitone--cg2)">
