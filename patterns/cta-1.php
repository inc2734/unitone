...
<div data-layout="decorator" class="alignfull has-white-color has-unitone-accent-gradient-background has-text-color has-background">
	<!-- wp:unitone/gutters {"lock":{"move":true,"remove":true}} -->
	<div data-layout="gutters">
		<!-- wp:unitone/container {"lock":{"move":true,"remove":true}} -->
		<div data-layout="container">
			<!-- wp:unitone/with-sidebar {"sidebarWidth":"var(--cg3)","lock":{"move":true,"remove":true},"unitone":{"alignItems":"center"}} -->
			<div data-layout="with-sidebar -sidebar:right -align-items:center" style="--sidebar-width:var(--cg3)">
