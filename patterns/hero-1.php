...
<section data-layout="decorator" class="alignfull">
	...
	<div data-layout="container">
		...
		<div data-layout="cover -justify-content:center" style="--min-height:50vh">
			<!-- wp:unitone/with-sidebar {"unitone":{"alignItems":"center","lock":{"remove":true,"move":true}}} -->
			<div data-layout="with-sidebar -sidebar:right -align-items:center">
				...
				<div data-layout="with-sidebar__content">
					...
					<p class="has-unitone-6-xl-font-size" data-layout="-fluid-typography">Lorem</p>
					<!-- /wp:paragraph -->
				</div>
