<?php
/**
 * Title: Page Header (Slim) for Single Posts
 * Slug: unitone/template/single/page-header/slim
 * Inserter: false
 */
?>
<!-- wp:unitone/section {"tagName":"header","align":"full","unitone":{"padding":"0","gutters":"root","maxWidth":"var(--wp--style--global--content-size)","gap":"-2"}} -->
