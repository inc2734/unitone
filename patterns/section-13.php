<?php
/**
 * Title: Section (Slim and full width content / Bright gray background)
 * Slug: unitone/section/13
 * Categories: section
 * Block Types: unitone/decorator, unitone/gutters
 */
?>
<!-- wp:unitone/decorator {"tagName":"section","align":"full","backgroundColor":"unitone/bright-gray"} -->
<section data-unitone-layout="decorator" class="alignfull has-unitone-bright-gray-background-color has-background">
