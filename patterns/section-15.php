<?php
/**
 * Title: Section (Right image / Shifted background)
 * Slug: unitone/section/15
 * Categories: section
...
<section data-layout="decorator" class="alignfull">
	<!-- wp:unitone/decorator {"position":"absolute","top":"calc(var(--s3) * -1)","right":"0","bottom":"30%","left":"0","zIndex":"-1","lock":{"move":true,"remove":true},"gradient":"unitone-accent"} -->
	<div style="--top:calc(var(--s3) * -1);--right:0;--bottom:30%;--left:0;--z-index:-1" data-layout="decorator -position:absolute" class="has-unitone-accent-gradient-background has-background"></div>
	...
	<div data-layout="gutters">
		...
		<div data-layout="container">
			<!-- wp:unitone/with-sidebar {"sidebarWidth":"var(--cg4)","contentMaxWidth":"var(--measure)","lock":{"move":true,"remove":true},"unitone":{"alignItems":"start"}} -->
			<div data-layout="with-sidebar -sidebar:right -align-items:start" style="--sidebar-width:var(--cg4);--content-max-width:var(--measure)">
				<!-- wp:unitone/with-sidebar-content {"unitone":{"blockAlign":"center"},"lock":{"move":true,"remove":true}} -->
				<div data-layout="with-sidebar__content -align:center">
					...
					<div data-layout="stack">
						...
						<div data-layout="decorator -padding:2" class="has-white-color has-text-color">
						...
						<div data-layout="decorator -padding:2" class="has-white-background-color has-background">
