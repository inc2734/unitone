...
<div data-layout="decorator -position:relative" class="alignfull">
	<!-- wp:unitone/decorator {"position":"absolute","top":"0","right":"max((50% - var(--container-max-width) / 2 + var(--pg1)), var(--s1))","bottom":"0","left":"0","lock":{"move":true,"remove":true},"backgroundColor":"unitone/accent"} -->
	<div style="--top:0;--right:max((50% - var(--container-max-width) / 2 + var(--pg1)), var(--s1));--bottom:0;--left:0" data-layout="decorator -position:absolute" class="has-unitone-accent-background-color has-background"></div>
	...
	<div data-layout="gutters -padding:2">
		...
		<div data-layout="container">
			...
			<div data-layout="stack -gap:2">
				<!-- wp:unitone/container {"unitone":{"gutters":"0","maxWidth":"var(--pg11)","blockAlign":"end"}} -->
				<div data-layout="container -align:end -gutters:0" style="--max-width:var(--pg11)">
