...
<div data-unitone-layout="decorator -position:relative" class="alignfull">
	<!-- wp:unitone/decorator {"position":"absolute","top":"0","right":"max((50% - var(--unitone--container-max-width) / 2 + var(--unitone--pg1)), var(--unitone--s1))","bottom":"0","left":"0","lock":{"move":true,"remove":true},"backgroundColor":"unitone/accent"} -->
	<div style="--unitone--top:0;--unitone--right:max((50% - var(--unitone--container-max-width) / 2 + var(--unitone--pg1)), var(--unitone--s1));--unitone--bottom:0;--unitone--left:0" data-unitone-layout="decorator -position:absolute" class="has-unitone-accent-background-color has-background"></div>
	...
	<div data-unitone-layout="gutters -padding:2">
		...
		<div data-unitone-layout="container">
			...
			<div data-unitone-layout="stack -gap:2">
				<!-- wp:unitone/container {"unitone":{"gutters":"0","maxWidth":"var(--unitone--pg11)","blockAlign":"end"}} -->
				<div data-unitone-layout="container -align:end -gutters:0" style="--unitone--max-width:var(--unitone--pg11)">
