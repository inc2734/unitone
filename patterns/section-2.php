...
<section data-layout="decorator" class="alignfull">
	...
	<div data-layout="gutters">
		...
		<div data-layout="container">
			<!-- wp:unitone/with-sidebar {"sidebarWidth":"var(--cg4)","contentMaxWidth":"var(--measure)","revert":true,"sidebar":"left","lock":{"move":true,"remove":true},"unitone":{"gap":"2","alignItems":"center"}} -->
			<div data-layout="with-sidebar -sidebar:left -revert -align-items:center -gap:2" style="--sidebar-width:var(--cg4);--content-max-width:var(--measure)">
