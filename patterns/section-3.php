...
<section data-unitone-layout="decorator" class="alignfull">
	...
	<div data-unitone-layout="gutters">
		...
		<div data-unitone-layout="container">
			<!-- wp:unitone/with-sidebar {"sidebarWidth":"var(--unitone--cg3)","contentMinWidth":"var(--unitone--pg7)","sidebar":"left","unitone":{"gap":"2"},"lock":{"remove":true}} -->
			<div data-unitone-layout="with-sidebar -sidebar:left -gap:2" style="--unitone--sidebar-width:var(--unitone--cg3);--unitone--content-min-width:var(--unitone--pg7)">
