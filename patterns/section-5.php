...
<section data-layout="decorator" class="alignfull">
	...
	<div data-layout="gutters">
		...
		<div data-layout="container">
			<!-- wp:unitone/with-sidebar {"sidebarWidth":"var(--cg3)","contentMinWidth":"var(--pg7)","revert":true,"sidebar":"right","unitone":{"gap":"2"},"lock":{"remove":true}} -->
			<div data-layout="with-sidebar -sidebar:right -revert -gap:2" style="--sidebar-width:var(--cg3);--content-min-width:var(--pg7)">
