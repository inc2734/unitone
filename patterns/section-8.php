<?php
/**
 * Title: Section (Right large image)
 * Slug: unitone/section/8
 * Categories: section
...
<section data-unitone-layout="decorator" class="alignfull">
	...
	<div data-unitone-layout="gutters">
		<!-- wp:unitone/with-sidebar {"sidebarWidth":"max(50%, var(--unitone--cg4))","contentMaxWidth":"var(--unitone--measure)","lock":{"move":true,"remove":true},"unitone":{"gap":"0","alignItems":"center"}} -->
		<div data-unitone-layout="with-sidebar -sidebar:right -align-items:center -gap:0" style="--unitone--sidebar-width:max(50%, var(--unitone--cg4));--unitone--content-max-width:var(--unitone--measure)">
