...
<section data-layout="decorator" class="alignfull">
	...
	<div data-layout="gutters">
		<!-- wp:unitone/with-sidebar {"sidebarWidth":"max(50%, var(--cg4))","contentMaxWidth":"var(--measure)","lock":{"move":true,"remove":true},"unitone":{"gap":"0","alignItems":"center"}} -->
		<div data-layout="with-sidebar -sidebar:right -align-items:center -gap:0" style="--sidebar-width:max(50%, var(--cg4));--content-max-width:var(--measure)">
