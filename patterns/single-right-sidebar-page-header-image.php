<?php
/**
 * Title: Single Posts: Right Sidebar / Page Header (Image)
 * Slug: unitone/single-right-sidebar-page-header-image
...
<div data-unitone-layout="cover -no-padding" class="site-container-right-sidebar">
	...
	<div data-unitone-layout="cover__content -fill -valign:center">
		<!-- wp:pattern {"slug":"unitone/single/main/right-sidebar-page-header-image"} /-->
	</div>
	<!-- /wp:unitone/cover-content -->
