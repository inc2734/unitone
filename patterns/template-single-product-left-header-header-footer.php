<?php
/**
 * Title: Single Products: Left Header / Only Header and Footer
 * Slug: unitone/template/single-product/left-header-header-footer
...
<div data-unitone-layout="cover -no-padding" class="site-container-left-header">
	...
	<div data-unitone-layout="cover__content -fill -valign:center">
		<!-- wp:pattern {"slug":"unitone/template/single-product/main/one-column"} /-->
	</div>
	<!-- /wp:unitone/cover-content -->
