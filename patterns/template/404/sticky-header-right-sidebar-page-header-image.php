<?php
/**
 * Title: 404: Sticky Header / Right Sidebar / Page Header (Image)
 * Slug: unitone/template/404/sticky-header-right-sidebar-page-header-image
...
<div data-unitone-layout="cover">
	...
	<div data-unitone-layout="cover__content -fill -valign:center">
		<!-- wp:pattern {"slug":"unitone/template/404/main/right-sidebar-page-header-image"} /-->
	</div>
	<!-- /wp:unitone/cover-content -->
