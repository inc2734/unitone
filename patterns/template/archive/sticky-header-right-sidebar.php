<?php
/**
 * Title: All Archives: Sticky Header / Right Sidebar
 * Slug: unitone/template/archive/sticky-header-right-sidebar
...
<div data-unitone-layout="cover">
	...
	<div data-unitone-layout="cover__content -fill -valign:center">
		<!-- wp:pattern {"slug":"unitone/template/archive/main/right-sidebar"} /-->
	</div>
	<!-- /wp:unitone/cover-content -->
