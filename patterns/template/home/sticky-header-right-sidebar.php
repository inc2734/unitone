<?php
/**
 * Title: Blog Home: Sticky Header / Right Sidebar
 * Slug: unitone/template/home/sticky-header-right-sidebar
...
<div data-unitone-layout="cover">
	...
	<div data-unitone-layout="cover__content -fill -valign:center">
		<!-- wp:pattern {"slug":"unitone/template/home/main/right-sidebar"} /-->
	</div>
	<!-- /wp:unitone/cover-content -->
