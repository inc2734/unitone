<?php
/**
 * Title: Pages: Sticky Header / One Column / Page Header (Slim)
 * Slug: unitone/template/page/sticky-header-one-column-page-header-slim
...
<div data-unitone-layout="cover">
	...
	<div data-unitone-layout="cover__content -fill -valign:center">
		<!-- wp:pattern {"slug":"unitone/template/page/main/one-column-page-header-slim"} /-->
	</div>
	<!-- /wp:unitone/cover-content -->
