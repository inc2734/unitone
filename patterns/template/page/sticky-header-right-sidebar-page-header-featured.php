<?php
/**
 * Title: Pages: Sticky Header / Right Sidebar / Page Header (Featured Image)
 * Slug: unitone/template/page/sticky-header-right-sidebar-page-header-featured
...
<div data-unitone-layout="cover">
	...
	<div data-unitone-layout="cover__content -fill -valign:center">
		<!-- wp:pattern {"slug":"unitone/template/page/main/right-sidebar/page-header-featured"} /-->
	</div>
	<!-- /wp:unitone/cover-content -->
