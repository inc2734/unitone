<?php
/**
 * Title: Search Results: Sticky Header / Right Sidebar / Page Header (Image)
 * Slug: unitone/template/search/sticky-header-right-sidebar-page-header-image
...
<div data-unitone-layout="cover">
	...
	<div data-unitone-layout="cover__content -fill -valign:center">
		<!-- wp:pattern {"slug":"unitone/template/search/main/right-sidebar-page-header-image"} /-->
	</div>
	<!-- /wp:unitone/cover-content -->
