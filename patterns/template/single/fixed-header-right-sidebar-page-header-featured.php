<?php
/**
 * Title: Single Posts: Fixed Header / Right Sidebar / Page Header (Featured Image)
 * Slug: unitone/template/single/fixed-header-right-sidebar-page-header-featured
...
<div data-unitone-layout="cover">
	...
	<div data-unitone-layout="cover__content -valign:top">
		<!-- wp:template-part {"slug":"header-fixed","tagName":"header","area":"header","className":"site-header"} /-->
	</div>
