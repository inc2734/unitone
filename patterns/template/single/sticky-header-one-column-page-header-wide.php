<?php
/**
 * Title: Single Posts: Sticky Header / One Column / Page Header (Wide)
 * Slug: unitone/template/single/sticky-header-one-column-page-header-wide
...
<div data-unitone-layout="cover">
	...
	<div data-unitone-layout="cover__content -fill -valign:center">
		<!-- wp:pattern {"slug":"unitone/template/single/main/one-column-page-header-wide"} /-->
	</div>
	<!-- /wp:unitone/cover-content -->
