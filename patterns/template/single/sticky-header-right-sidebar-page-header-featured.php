<?php
/**
 * Title: Single Posts: Sticky Header / Right Sidebar / Page Header (Featured Image)
 * Slug: unitone/template/single/sticky-header-right-sidebar-page-header-featured
...
<div data-unitone-layout="cover">
	...
	<div data-unitone-layout="cover__content -valign:top">
		<!-- wp:template-part {"slug":"header-sticky","tagName":"header","area":"header","className":"site-header"} /-->
	</div>
	...
	<div data-unitone-layout="cover__content -fill -valign:center">
		<!-- wp:pattern {"slug":"unitone/template/single/main/right-sidebar-page-header-featured"} /-->
	</div>
	<!-- /wp:unitone/cover-content -->
